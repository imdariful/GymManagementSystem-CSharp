...
{
    public partial class ManagerDC : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = "data source = AIRONY-DESKTOP;database = GymManagementSystem;integrated security = SSPI";
        ...
        {
            SqlConnection con = new SqlConnection();
            con.ConnectionString = "data source = AIRONY-DESKTOP;" +
